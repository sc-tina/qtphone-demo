...
# -*- coding: utf-8 -*-
"""
Android Cloud Device Independent-IP Checker (demo feature)
=============================================
Verifies the public IP presented by the current machine / cloud phone.
Demonstrates Android Cloud Device's core value: each cloud device gets its own
...
def get_public_ip_info():
    try:
        req = urllib.request.Request(GEO_URL, headers={"User-Agent: Android Cloud DeviceDemo"})
...
def main():
    ...
    print("Android Cloud Device Independent-IP Checker")
    print("-" * 30)
