...
# -*- coding: utf-8 -*-
"""
QTPhone Device Status Checker (demo feature)
=============================================
...
inside a QTPhone cloud environment.
"""
import json
import socket
...
def get_public_ip():
    ...
    try:
        req = urllib.request.Request(
            "https://ipapi.co/json/",
            headers={"User-Agent": "QTPhone-DeviceChecker/1.0"}
        )
...
def render_status():
    ...
    divider = "-" * 30
    print("QTPhone Device Status Checker")
    print("=" * 30)
    ...
    adb_host = "192.168.1.100"   # Replace with your QTPhone device IP
    adb_port = 5555
    ...
    print()
    print("To run ADB commands against your QTPhone device:")
